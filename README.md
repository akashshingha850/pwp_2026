...
```bash
git clone --recurse-submodules https://github.com/akashshingha850/pwp_2026.git
cd pwp_2026
```

<mark> Please refer to the API submodule for instructions on setting up the REST API server. </mark>